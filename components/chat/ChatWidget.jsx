...
export default function ChatWidget() {
  ...
  const getSmartReply = (text) => {
    ...
    const responses = {
      ...
      contact: [
        "Свяжитесь с нами: +998 91 162 35 99 или email: info@company.uz.",
        "Колл-центр: +998 91 162 35 99. Также можете написать здесь в чате — мы на связи.",
      ],
      help: [
        "Я могу помочь с:",
    ...
    const defaults = [
      ...
      "По этой теме нет точной информации. Позвоните, пожалуйста, по номеру +998 91 162 35 99.",
