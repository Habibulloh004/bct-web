          ...
          >
            ...
            <div className="w-full flex justify-center items-center flex-col gap-3 sm:gap-4 pt-4 sm:pt-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="text-white bg-black hover:bg-black/80 w-full sm:min-w-1/2 md:w-auto md:min-w-[200px] p-2 sm:p-3 md:p-2 rounded-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base transition-all duration-200"
              >
