...
export default function CategoryItem({ item }) {
  ...
  return (
    <Link href={createCategoryPath(item, i18n.language)} className='bg-[#EBEBEB99] rounded-2xl p-4'>
      ...
      <div className='flex justify-center flex-col items-center gap-2 w-full'>
        <h3 className='text-xl font-medium'>{getTranslatedValue(item?.name, i18n?.language)}</h3>
