...
export default function OrderConfirmForm() {
  ...
  if (orderSuccess) {
    return (
      <div className="h-full w-11/12 max-w-[800px] mx-auto pt-4">
        <div className="bg-white rounded-xl border p-4 md:p-6 lg:p-10 shadow-sm text-center">
          {/* Success Icon */}
  ...
  return (
    <div className="h-full w-11/12 max-w-[1200px] mx-auto pt-4">
      <div className="bg-white rounded-xl border p-4 md:p-6 lg:p-10 shadow-sm">
        <Form {...form}>
          <form
          ...
          >
            ...
            <div className="w-full flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                type="submit"
                className="h-11 w-full sm:w-[200px] bg-primary text-white order-1 sm:order-2 disabled:opacity-50"
