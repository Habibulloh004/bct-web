...
export default function WarrantyCheck() {
  ...
  return (
    <div className=" mx-auto max-w-5xl w-11/12 px-4">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 space-y-4">
          {/* Warranty check form */}
          <div className="bg-white border rounded-lg p-4 md:p-6 space-y-3">
          ...
          {/* Customer details */}
          <div className="bg-white border rounded-lg p-4 md:p-6 space-y-3 text-sm">
        ...
        <div className="flex-1 space-y-4">
          {/* Product image */}
          <div className="bg-white border rounded-lg p-4 md:p-6 flex flex-col items-center gap-4">
          ...
          <div className="bg-white border rounded-lg p-4 md:p-6 text-center">
