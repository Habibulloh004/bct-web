          ...
          >
            ...
            <div className="w-full flex justify-center items-center flex-col gap-3 sm:gap-4 pt-4 sm:pt-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="text-white bg-primary hover:bg-primary/80 w-full sm:w-auto sm:min-w-[200px] md:min-w-[250px] p-2 sm:p-3 md:p-2 rounded-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base transition-all duration-200"
              >
